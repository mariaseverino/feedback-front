        ...
        <aside className="px-10 flex flex-col justify-between fixed h-screen py-11">
            <div className="flex flex-col items-start">
                ...
                <div className="bg-white rounded-[54px] p-2 flex flex-col gap-10">
                    <div className="flex flex-col gap-1">
                        <Link
                            to="/visao-geral"
                            className="size-15 rounded-full flex items-center justify-center text-2xl [&.active]:text-white [&.active]:bg-primary hover:bg-primary/5"
                        >
                            <Component />
                        </Link>
                        <Link
            ...
            <div className="flex flex-col items-center justify-center gap-8">
                <button
                    ...
                    className="size-15 rounded-full flex items-center justify-center [&.active]:text-white [&.active]:bg-primary hover:bg-primary/5"
                >
                    <LogOut />
                </button>
...
export function SideBar() {
    ...
    return (
        <aside className="fixed left-0 top-0 flex h-screen flex-col justify-between overflow-y-auto py-10 px-8">
            <div className="flex flex-col items-start">
                {/* <div className="mb-12 flex items-center gap-2 pl-2 text-2xl font-semibold text-primary">
                    <MessagesSquare size={32} />
                    Ecoa
                </div> */}
